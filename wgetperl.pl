...
my @xname = ("Googurl (C) 2017","www.Google.com","* Im to lame to read Bitchx.doc *","BitchX",
	"mIRC 6.1","* Im so lame i cant ready BitchX.doc *","Bill Gates","crew molinow","crew molinow","rumahtangga.web.id","nozzz",
	...
	"www.packetstormsecurity.org","www.linux.com","www.freebsd.org","Hello There","capadesubooks.web.id","skillmu.id");
